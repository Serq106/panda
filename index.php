		...
		<div class="header">
			...
			<div class="select">
				<form id="myForm" class="myForm" method="post" action="main.php">	
					...
					<input type="text" value="" name="text" id="text" placeholder="введите # или слово" style="width: 69%;height: 40px;margin-right: 10px;">
					<div class="asd" >
						<input type="text" value="" name="last_name" id="text" placeholder="Введите имя" style="width: 69%;height: 40px;margin-right: 10px;">
						<input type="text" value="" name="first_name" id="text" placeholder="Введите фамилию" style="width: 69%;height: 40px;margin-right: 10px;">
					</div>
